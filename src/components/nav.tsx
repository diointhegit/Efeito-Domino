    ...
    <nav className="py-2">
      ...
      {isOpen && (
        <div className="bg-black/80 fixed  w-full inset-0 ">
          <div className="bg-light-bg h-full  w-2/3 absolute right-0 z-20 ">
            ...
            <div className=" my-6 ">
              <Link
                href="/app/home"
                className={cn(
                  "relative w-fit block after:block after:content-[''] after:absolute after:h-[3px] after:bg-primary after:w-full after:scale-x-0 after:hover:scale-x-100 after:transition after:duration-300 after:origin-left px-5 py-5",
